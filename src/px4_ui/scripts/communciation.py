...
class Communication:
    ...
    def __init__(self, vehicle_type, vehicle_id):
        ...
        self.cmd_pose_flu_sub = rospy.Subscriber("mavros/setpoint_from_station/pose", Pose, self.cmd_pose_flu_callback,queue_size=1)
...
#        target_raw_pose.position.z = z
        target_raw_pose.position = self.Pose_.position
    ...
    def cmd_pose_flu_callback(self, msg):
        ...
        self.motion_type = 0
        self.Pose_.position.x = msg.position.x
        self.Pose_.position.y = msg.position.y
        self.Pose_.position.z = msg.position.z
