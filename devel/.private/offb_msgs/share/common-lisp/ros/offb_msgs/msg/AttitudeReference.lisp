...
(cl:defmethod cl:initialize-instance :after ((m <AttitudeReference>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AttitudeReference)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offb_msgs-msg:<AttitudeReference> is deprecated: use offb_msgs-msg:AttitudeReference instead.")))
...
(cl:defmethod throttle_sp-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_msgs-msg:throttle_sp-val is deprecated.  Use offb_msgs-msg:throttle_sp instead.")
  (throttle_sp m))

(cl:ensure-generic-function 'desired_throttle-val :lambda-list '(m))
(cl:defmethod desired_throttle-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_msgs-msg:desired_throttle-val is deprecated.  Use offb_msgs-msg:desired_throttle instead.")
  (desired_throttle m))

(cl:ensure-generic-function 'desired_attitude-val :lambda-list '(m))
(cl:defmethod desired_attitude-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_msgs-msg:desired_attitude-val is deprecated.  Use offb_msgs-msg:desired_attitude instead.")
  (desired_attitude m))

(cl:ensure-generic-function 'desired_att_q-val :lambda-list '(m))
(cl:defmethod desired_att_q-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_msgs-msg:desired_att_q-val is deprecated.  Use offb_msgs-msg:desired_att_q instead.")
  (desired_att_q m))
