...
(cl:defclass <MultiArucoInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (aruco_infos
    :reader aruco_infos
    :initarg :aruco_infos
    :type (cl:vector offb_msgs-msg:ArucoInfo)
   :initform (cl:make-array 0 :element-type 'offb_msgs-msg:ArucoInfo :initial-element (cl:make-instance 'offb_msgs-msg:ArucoInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MultiArucoInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiArucoInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offb_msgs-msg:<MultiArucoInfo> is deprecated: use offb_msgs-msg:MultiArucoInfo instead.")))
...
(cl:defmethod num_arucos-val ((m <MultiArucoInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_msgs-msg:num_arucos-val is deprecated.  Use offb_msgs-msg:num_arucos instead.")
  (num_arucos m))

(cl:ensure-generic-function 'aruco_infos-val :lambda-list '(m))
(cl:defmethod aruco_infos-val ((m <MultiArucoInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offb_msgs-msg:aruco_infos-val is deprecated.  Use offb_msgs-msg:aruco_infos instead.")
  (aruco_infos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MultiArucoInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'aruco_infos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'offb_msgs-msg:ArucoInfo))
