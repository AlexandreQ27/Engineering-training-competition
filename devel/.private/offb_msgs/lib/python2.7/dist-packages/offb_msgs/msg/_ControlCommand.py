...
"""autogenerated by genpy from offb_msgs/ControlCommand.msg. Do not edit."""
import codecs
import sys
...
class ControlCommand(genpy.Message):
  _md5sum = "52cf86f1a544868c4ad859f9c81a2e20"
  _type = "offb_msgs/ControlCommand"
...
## float32 yaw_acceleration_ref     ## [rad/s] """
  ...
  _slot_types = ['std_msgs/Header','uint32','string','uint8','offb_msgs/PositionReference']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.Reference_State is None:
        self.Reference_State = offb_msgs.msg.PositionReference()
    else:
      self.header = std_msgs.msg.Header()
      self.Command_ID = 0
      self.source = ''
