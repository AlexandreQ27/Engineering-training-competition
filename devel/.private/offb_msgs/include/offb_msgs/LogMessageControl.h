// Generated by gencpp from file offb_msgs/LogMessageControl.msg
// DO NOT EDIT!


#ifndef OFFB_MSGS_MESSAGE_LOGMESSAGECONTROL_H
#define OFFB_MSGS_MESSAGE_LOGMESSAGECONTROL_H
...
struct LogMessageControl_
{
  ...
  typedef boost::shared_ptr< ::offb_msgs::LogMessageControl_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::offb_msgs::LogMessageControl_<ContainerAllocator> const> ConstPtr;

}; // struct LogMessageControl_

typedef ::offb_msgs::LogMessageControl_<std::allocator<void> > LogMessageControl;

typedef boost::shared_ptr< ::offb_msgs::LogMessageControl > LogMessageControlPtr;
typedef boost::shared_ptr< ::offb_msgs::LogMessageControl const> LogMessageControlConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::offb_msgs::LogMessageControl_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::offb_msgs::LogMessageControl_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::offb_msgs::LogMessageControl_<ContainerAllocator1> & lhs, const ::offb_msgs::LogMessageControl_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::LogMessageControl_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::LogMessageControl_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::LogMessageControl_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
{
  ...
  static const char* value(const ::offb_msgs::LogMessageControl_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5781c2d06de4d7c7ULL;
  static const uint64_t static_value2 = 0xa326052cb8307187ULL;
};

template<class ContainerAllocator>
struct DataType< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::offb_msgs::LogMessageControl_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::offb_msgs::LogMessageControl_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OFFB_MSGS_MESSAGE_LOGMESSAGECONTROL_H
