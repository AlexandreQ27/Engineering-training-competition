// Generated by gencpp from file offb_msgs/SwarmCommand.msg
// DO NOT EDIT!


#ifndef OFFB_MSGS_MESSAGE_SWARMCOMMAND_H
#define OFFB_MSGS_MESSAGE_SWARMCOMMAND_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::offb_msgs::SwarmCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::offb_msgs::SwarmCommand_<ContainerAllocator> const> ConstPtr;

}; // struct SwarmCommand_

typedef ::offb_msgs::SwarmCommand_<std::allocator<void> > SwarmCommand;

typedef boost::shared_ptr< ::offb_msgs::SwarmCommand > SwarmCommandPtr;
typedef boost::shared_ptr< ::offb_msgs::SwarmCommand const> SwarmCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::offb_msgs::SwarmCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::offb_msgs::SwarmCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::offb_msgs::SwarmCommand_<ContainerAllocator1> & lhs, const ::offb_msgs::SwarmCommand_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::SwarmCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::SwarmCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::SwarmCommand_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::offb_msgs::SwarmCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf0e68f41f7d26607ULL;
  static const uint64_t static_value2 = 0x969a5fba3d80e691ULL;
};

template<class ContainerAllocator>
struct DataType< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::offb_msgs::SwarmCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::offb_msgs::SwarmCommand_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OFFB_MSGS_MESSAGE_SWARMCOMMAND_H
