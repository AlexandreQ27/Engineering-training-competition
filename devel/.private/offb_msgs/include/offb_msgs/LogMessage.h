// Generated by gencpp from file offb_msgs/LogMessage.msg
// DO NOT EDIT!


#ifndef OFFB_MSGS_MESSAGE_LOGMESSAGE_H
#define OFFB_MSGS_MESSAGE_LOGMESSAGE_H
...
struct LogMessage_
{
  ...
  typedef boost::shared_ptr< ::offb_msgs::LogMessage_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::offb_msgs::LogMessage_<ContainerAllocator> const> ConstPtr;

}; // struct LogMessage_

typedef ::offb_msgs::LogMessage_<std::allocator<void> > LogMessage;

typedef boost::shared_ptr< ::offb_msgs::LogMessage > LogMessagePtr;
typedef boost::shared_ptr< ::offb_msgs::LogMessage const> LogMessageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::offb_msgs::LogMessage_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::offb_msgs::LogMessage_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::offb_msgs::LogMessage_<ContainerAllocator1> & lhs, const ::offb_msgs::LogMessage_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::LogMessage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::LogMessage_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::LogMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::LogMessage_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::LogMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::LogMessage_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::offb_msgs::LogMessage_<ContainerAllocator> >
{
  ...
  static const char* value(const ::offb_msgs::LogMessage_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2d4ad0bb816c6f34ULL;
  static const uint64_t static_value2 = 0x27390d4683b646bfULL;
};

template<class ContainerAllocator>
struct DataType< ::offb_msgs::LogMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::offb_msgs::LogMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::offb_msgs::LogMessage_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::offb_msgs::LogMessage_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::offb_msgs::LogMessage_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OFFB_MSGS_MESSAGE_LOGMESSAGE_H
