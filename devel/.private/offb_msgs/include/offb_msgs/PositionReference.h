// Generated by gencpp from file offb_msgs/PositionReference.msg
// DO NOT EDIT!


#ifndef OFFB_MSGS_MESSAGE_POSITIONREFERENCE_H
#define OFFB_MSGS_MESSAGE_POSITIONREFERENCE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::offb_msgs::PositionReference_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::offb_msgs::PositionReference_<ContainerAllocator> const> ConstPtr;

}; // struct PositionReference_

typedef ::offb_msgs::PositionReference_<std::allocator<void> > PositionReference;

typedef boost::shared_ptr< ::offb_msgs::PositionReference > PositionReferencePtr;
typedef boost::shared_ptr< ::offb_msgs::PositionReference const> PositionReferenceConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::offb_msgs::PositionReference_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::offb_msgs::PositionReference_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::offb_msgs::PositionReference_<ContainerAllocator1> & lhs, const ::offb_msgs::PositionReference_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::PositionReference_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::offb_msgs::PositionReference_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::PositionReference_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::offb_msgs::PositionReference_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::PositionReference_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::offb_msgs::PositionReference_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::offb_msgs::PositionReference_<ContainerAllocator> >
{
  ...
  static const char* value(const ::offb_msgs::PositionReference_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9ad4ca13cd19c5a6ULL;
  static const uint64_t static_value2 = 0x704afba61c385596ULL;
};

template<class ContainerAllocator>
struct DataType< ::offb_msgs::PositionReference_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::offb_msgs::PositionReference_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::offb_msgs::PositionReference_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::offb_msgs::PositionReference_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::offb_msgs::PositionReference_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OFFB_MSGS_MESSAGE_POSITIONREFERENCE_H
