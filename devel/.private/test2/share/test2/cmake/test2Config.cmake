...
if("TRUE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/qyb/catkin_ws/src/test2)
  set(test2_DEVEL_PREFIX /home/qyb/catkin_ws/devel/.private/test2)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /home/qyb/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qyb/catkin_ws/src/test2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/qyb/catkin_ws/devel/.private/test2/lib;/home/qyb/catkin_ws/devel/lib;/opt/ros/melodic/lib)
